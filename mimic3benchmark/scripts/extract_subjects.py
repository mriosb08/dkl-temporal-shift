...
parser.add_argument('--extract_notes', '-n', action='store_true', help='extract notes')
...
if args.test:
    pat_idx = np.random.choice(patients.shape[0], size=10000)
...
#notes TODO
if args.extract_notes:
    break_up_notes_by_subject(notes, args.output_path, subjects=subjects, verbose=args.verbose)
