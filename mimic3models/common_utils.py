...
def add_common_arguments(parser):
    ...
    parser.add_argument('--bidirectional', dest='bidirectional', action='store_true', help='Use BiLSTM')
    parser.add_argument('--depth', type=int, default=1,
                        help='number of bi-LSTMs')
    parser.add_argument('--epochs', type=int, default=100,
                        help='number of chunks to train')
    parser.add_argument('--vocab_size', type=int, default=83158,
                        help='vocab emb size')
    ...
    parser.add_argument('--stop_words', dest='stop_words', action='store_true')
